...
class FCN32_VGG16:
    ...
    def train(self, sess,
        ...
        if ckpt_dir is None:
            ...
            checkpoint_dir = os.path.join(ckpt_dir, 'fcn32vgg16')
    ...
    def _create_vgg16_conv_layers(self):
        ...
        with tf.name_scope('conv1_2') as scope:
            ...
            tf.summary.histogram('activations', conv1_2)
            self._parameters += [kernel, biases]
        ...
        with tf.name_scope('conv2_2') as scope:
            ...
            tf.summary.histogram('activations', conv2_2)
            self._parameters += [kernel, biases]
        ...
        with tf.name_scope('conv4_1') as scope:
            ...
            tf.summary.histogram('activations', conv4_1)
            self._parameters += [kernel, biases]
        ...
        with tf.name_scope('conv4_2') as scope:
            ...
            tf.summary.histogram('activations', conv4_2)
            self._parameters += [kernel, biases]
        ...
        with tf.name_scope('conv4_3') as scope:
            ...
            tf.summary.histogram('activations', conv4_3)
            self._parameters += [kernel, biases]
        ...
        with tf.name_scope('conv5_1') as scope:
            ...
            tf.summary.histogram('activations', conv5_1)
            self._parameters += [kernel, biases]
        ...
        with tf.name_scope('conv5_2') as scope:
            ...
            tf.summary.histogram('activations', conv5_2)
            self._parameters += [kernel, biases]
        ...
        with tf.name_scope('conv5_3') as scope:
            ...
            tf.summary.histogram('activations', conv5_3)
            self._parameters += [kernel, biases]
    ...
    def _create_vgg16_fc_conv_layers(self):
        ...
        with tf.name_scope('conv6') as scope:
            ...
            tf.summary.histogram('activations_withdropout', conv6)
            self._parameters += [kernel, biases]
        ...
        with tf.name_scope('conv7') as scope:
            ...
            tf.summary.histogram('activations_withdropout', self._conv7)
            self._parameters += [kernel, biases]
    ...
    def _create_decoder(self):
        ...
        with tf.name_scope("decoder"):
            ...
            #skip4 = tf.add(up4, self._pool4, name='skip4')
            #up3
            #self._output = tf.layers.conv2d_transpose(skip4, 256,
            #                                 kernel_size=4, strides=2, padding='SAME',
            #                                 kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3),
            #                                 name='up3')
            #skip3 = tf.add(up3, self._pool3, name='skip3')
            self._output = tf.layers.conv2d_transpose(conv_1x1, self._num_classes,
                                             kernel_size=32, strides=32, padding='SAME',
                                             kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-4),
                                             name='output')
